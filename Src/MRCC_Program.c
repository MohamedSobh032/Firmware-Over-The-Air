...
/*****************************************************************************/
/* Func. Name: MRCC_voidEnablePeriphClock                                    */
/* i/p arguments: Copy_u8BusID: MRCC_BUS_AHB1 -->  MRCC_BUS_APB2LP           */
/* i/p arguments: Copy_u8PerId: [PeripheralName]EN || [PeripheralName]LPEN   */
/* o/p arguments: nothing                                                    */
...
{  
	switch (Copy_u8BusID) {
		case MRCC_BUS_AHB1:   SET_BIT(RCC_AHB1ENR,Copy_u8PeriphID);   break;
        case MRCC_BUS_AHB2:   SET_BIT(RCC_AHB2ENR,Copy_u8PeriphID);   break;
        case MRCC_BUS_APB1:   SET_BIT(RCC_APB1ENR,Copy_u8PeriphID);   break;
        case MRCC_BUS_APB2:   SET_BIT(RCC_APB2ENR,Copy_u8PeriphID);   break;
		case MRCC_BUS_AHB1LP: SET_BIT(RCC_AHB1LPENR,Copy_u8PeriphID); break;
        case MRCC_BUS_AHB2LP: SET_BIT(RCC_AHB2LPENR,Copy_u8PeriphID); break;
        case MRCC_BUS_APB1LP: SET_BIT(RCC_APB1LPENR,Copy_u8PeriphID); break;
        case MRCC_BUS_APB2LP: SET_BIT(RCC_APB2LPENR,Copy_u8PeriphID); break;
        default: break;
    }
}

/*****************************************************************************/
/* Func. Name: MRCC_voidDisablePeriphClock                                   */
/* i/p arguments: Copy_u8BusID: MRCC_BUS_AHB1 -->  MRCC_BUS_APB2LP           */
/* i/p arguments: Copy_u8PerId: [PeripheralName]EN || [PeripheralName]LPEN   */
/* o/p arguments: nothing                                                    */
/* Desc. : This API Allows the User to Enable CLK for a Specific Peripheral  */
...
{
	switch (Copy_u8BusID) {
		case MRCC_BUS_AHB1:   CLR_BIT(RCC_AHB1ENR,Copy_u8PeriphID);   break;
        case MRCC_BUS_AHB2:   CLR_BIT(RCC_AHB2ENR,Copy_u8PeriphID);   break;
        case MRCC_BUS_APB1:   CLR_BIT(RCC_APB1ENR,Copy_u8PeriphID);   break;
        case MRCC_BUS_APB2:   CLR_BIT(RCC_APB2ENR,Copy_u8PeriphID);   break;
		case MRCC_BUS_AHB1LP: CLR_BIT(RCC_AHB1LPENR,Copy_u8PeriphID); break;
        case MRCC_BUS_AHB2LP: CLR_BIT(RCC_AHB2LPENR,Copy_u8PeriphID); break;
        case MRCC_BUS_APB1LP: CLR_BIT(RCC_APB1LPENR,Copy_u8PeriphID); break;
        case MRCC_BUS_APB2LP: CLR_BIT(RCC_APB2LPENR,Copy_u8PeriphID); break;
        default: break;
    }
}
